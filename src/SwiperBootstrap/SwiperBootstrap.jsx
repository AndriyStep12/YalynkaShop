    ...
    return(
      <div className="sliedrBox">
        ...
        <div className="actionGet" id="actionGet">
          ...
          {DataBaseActions.map(index => index.items.map(item => <BoxAct key={item} box={item.box} price={item.price} imgItem={item.imgItem} nameClass={item.nameClass} nameT={item.nameT} locationItem={item.locationItem} inputNumb={item.inputNumb} />))}
